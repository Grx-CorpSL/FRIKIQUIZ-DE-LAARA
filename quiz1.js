...
function hablar(texto, callback) {
  ...
  if (synth.speaking) {
    synth.cancel(); // Cancelar si ya está hablando para no saturar
  }
...
function verificarRespuesta(seleccion) {
  ...
  // Bloqueamos botones para evitar pulsaciones múltiples
